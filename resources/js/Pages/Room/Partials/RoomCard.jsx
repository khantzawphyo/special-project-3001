...
export default function RoomCard({ name, count }) {
    return (
        <div className="flex h-full w-full items-center justify-center gap-x-4 rounded-3xl border-2 border-primary-purple/70 bg-[#925FE2]/25 py-8 dark:border-white/60">
