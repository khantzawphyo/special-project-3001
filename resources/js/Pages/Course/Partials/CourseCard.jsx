...
export default function CourseCard({ name, count }) {
    return (
        <div className="min-w-full gap-x-5 rounded-3xl border-2 border-primary-purple/70 bg-[#925FE2]/25 p-5 shadow-md dark:border-white md:w-full md:max-w-xs md:py-8">
